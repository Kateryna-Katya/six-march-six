            ...
            <div class="contact-cards">
                <div class="contact-card" data-aos="zoom-in" data-aos-delay="100">
                    <div class="contact-card__inner">
                        ...
                        <h2>Пишите нам</h2>
                        <p>Для вопросов и запросов на консалтинг:</p>
                        <a href="mailto:support@<?= $fullDomain ?>" class="contact-link">support@<?= $fullDomain ?></a>
                    </div>
                </div>

                <div class="contact-card contact-card--main" data-aos="zoom-in" data-aos-delay="200">
                    <div class="contact-card__inner">
                        <div class="contact-card__icon">
                            <i class="fa-solid fa-phone"></i>
                        </div>
                        <h2>Звоните</h2>
                        <p>Прямая линия поддержки и консультаций:</p>
                        <a href="tel:+493011414912" class="contact-link">+49 30 1141 4912</a>
                    </div>
                </div>
